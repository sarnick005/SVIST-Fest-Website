                  ...
                  <div className="single_propram">
                    <div className="inner_wrap">
                      ...
                      <div
                        ...
                        data-wow-delay=".5s"
                      >
                        <img src="/public/img/Enthuzea 2025/fest 2024/DSC_0608.JPG" alt=""></img>
                      </div>
                      {/* <h4 className="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s" style={{fontFamily:"Arial",fontWeight:"bold"}}>Mark the date: 20 May</h4> */}
                    </div>
                  </div>
                  ...
                  <div className="single_propram">
                    <div className="inner_wrap">
                      ...
                      <div
                        ...
                        data-wow-delay=".5s"
                      >
                        <img src="/public/img/Enthuzea 2025/fest 2024/DSC_0274.JPG" alt=""></img>
                      </div>
                      {/* <h4 className="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s" style={{fontFamily:"Arial",fontWeight:"bold"}}>Mark the date: 20 May</h4> */}
                    </div>
                  </div>
                  ...
                  <div className="single_propram">
                    <div className="inner_wrap">
                      ...
                      <div
                        ...
                        data-wow-delay=".5s"
                      >
                        <img src="/public/img/Enthuzea 2025/fest 2024/DSC_0872.JPG" alt=""></img>
                      </div>
                      {/* <h4 className="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s" style={{fontFamily:"Arial",fontWeight:"bold"}}>Mark the date: 20 May</h4> */}
                    </div>
                  </div>
